...
function writeEnglishNamesForTraining(
  itemsDataDirectory: string,
  getTextDataDirectory: string,
  outputDirectory: string
) {
  const enItemNames = _.compact(
    getEnglishItemNames(itemsDataDirectory, getTextDataDirectory).map((enItemName) => {
